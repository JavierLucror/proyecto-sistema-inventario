...
export class ProductosComponent implements OnInit {
  ...
  constructor(private dialog: MatDialog, private crudProductoService: CrudProductoService, private crudCategoriaService: CrudCategoriaService, private ruteador: Router) {}
